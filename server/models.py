...
class RestaurantPizza(db.Model):
    ...
    restaurant_id = db.Column('restaurant.id', db.Integer, db.ForeignKey('restaurant.id'), nullable=False)
    pizza_id = db.Column('pizza.id', db.Integer, db.ForeignKey('pizza.id'), nullable=False)
